...
from src.interfaces.api.auth_routes import register, authenticate
...
class TestAuthRoutes:
    ...
    def test_sign_in_handles_invalid_credentials(
        ...
        # Given
        message_bus.handle.side_effect = ValueError("사용자명 또는 비밀번호가 올바르지 않습니다")
        ...
        with app.test_request_context(
            ...
            assert response_data['error'] == '사용자명 또는 비밀번호가 올바르지 않습니다'