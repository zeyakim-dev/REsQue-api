...
class PasswordHasher:
    """비밀번호를 안전하게 해시화하는 클래스입니다.
    
    bcrypt 알고리즘을 사용하여 비밀번호를 해시화하고 검증합니다.
    work_factor를 통해 해싱의 강도를 조절할 수 있으며,
    기본값은 12로 설정되어 있습니다.
    """
    ...
    def __init__(self, work_factor: int = 12):
        """
        Args:
            work_factor: bcrypt의 반복 횟수를 결정하는 값입니다.
                        값이 1 증가할 때마다 해싱 시간이 2배로 증가합니다.
                        일반적으로 10-14 사이의 값을 권장합니다.
        """
    ...
    def hash(self, password: str) -> str:
        ...
        비밀번호를 UTF-8로 인코딩한 후 bcrypt로 해시화하고,
        결과를 문자열로 디코딩하여 반환합니다.
